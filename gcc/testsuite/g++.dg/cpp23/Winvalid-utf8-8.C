...
char32_t n = U'ğ€€€';				// { dg-bogus "invalid UTF-8 character <f0><80><80><80>" "" { target c++23 } }
char32_t o = U'ğ¿¿';				// { dg-bogus "invalid UTF-8 character <f0><8f><bf><bf>" "" { target c++23 } }
char32_t p = U'ô€€';				// { dg-bogus "invalid UTF-8 character <f4><90><80><80>" "" { target c++23 } }
char32_t q = U'ı¿¿¿¿¿';				// { dg-bogus "invalid UTF-8 character <fd><bf><bf><bf>" "" { target c++23 } }
...
auto O = U"ğ€€€";				// { dg-bogus "invalid UTF-8 character <f0><80><80><80>" "" { target c++23 } }
auto P = U"ğ¿¿";				// { dg-bogus "invalid UTF-8 character <f0><8f><bf><bf>" "" { target c++23 } }
auto Q = U"ô€€";				// { dg-bogus "invalid UTF-8 character <f4><90><80><80>" "" { target c++23 } }
auto R = U"ı¿¿¿¿¿";				// { dg-bogus "invalid UTF-8 character <fd><bf><bf><bf>" "" { target c++23 } }
						// { dg-bogus "invalid UTF-8 character <bf>" "" { target c++23 } .-1 }
...
auto O1 = UR"(ğ€€€)";				// { dg-bogus "invalid UTF-8 character <f0><80><80><80>" "" { target c++23 } }
auto P1 = UR"(ğ¿¿)";				// { dg-bogus "invalid UTF-8 character <f0><8f><bf><bf>" "" { target c++23 } }
auto Q1 = UR"(ô€€)";				// { dg-bogus "invalid UTF-8 character <f4><90><80><80>" "" { target c++23 } }
auto R1 = UR"(ı¿¿¿¿¿)";				// { dg-bogus "invalid UTF-8 character <fd><bf><bf><bf>" "" { target c++23 } }
						// { dg-bogus "invalid UTF-8 character <bf>" "" { target c++23 } .-1 }
...
auto O2 = u8"ğ€€€";				// { dg-bogus "invalid UTF-8 character <f0><80><80><80>" "" { target c++23 } }
auto P2 = u8"ğ¿¿";				// { dg-bogus "invalid UTF-8 character <f0><8f><bf><bf>" "" { target c++23 } }
auto Q2 = u8"ô€€";				// { dg-bogus "invalid UTF-8 character <f4><90><80><80>" "" { target c++23 } }
auto R2 = u8"ı¿¿¿¿¿";				// { dg-bogus "invalid UTF-8 character <fd><bf><bf><bf>" "" { target c++23 } }
						// { dg-bogus "invalid UTF-8 character <bf>" "" { target c++23 } .-1 }
