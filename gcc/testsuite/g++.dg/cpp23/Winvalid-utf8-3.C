...
// ağ€€€a				{ dg-error "invalid UTF-8 character <f0><80><80><80>" "" { target c++23 } }
// ağ¿¿a				{ dg-error "invalid UTF-8 character <f0><8f><bf><bf>" "" { target c++23 } }
// aô€€a				{ dg-error "invalid UTF-8 character <f4><90><80><80>" "" { target c++23 } }
// aı¿¿¿¿¿a				{ dg-error "invalid UTF-8 character <fd><bf><bf><bf>" "" { target c++23 } }
