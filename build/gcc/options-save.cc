		      ...
		      struct gcc_options *opts_set)
{
  ...
  gcc_assert (IN_RANGE (opts->x_flag_ext_dce, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_late_combine_instructions, -128, 127));
  ...
  ptr->x_param_vrp_block_limit = opts->x_param_vrp_block_limit;
  ...
  ptr->x_flag_ext_dce = opts->x_flag_ext_dce;
  ...
  ptr->x_flag_late_combine_instructions = opts->x_flag_late_combine_instructions;
  ...
  if (opts_set->x_param_vrp_block_limit) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_vrp_sparse_threshold) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_vrp_switch_limit) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_vrp_vector_threshold) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_min_function_alignment) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_openmp_target_simd_clone) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_sched_stalled_insns) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_sched_stalled_insns_dep) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_tree_parallelize_loops) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_ranger_debug) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_threader_debug) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_excess_precision) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[3] = mask;
  mask = 0;
  if (opts_set->x_flag_fp_contract_mode) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_noreturn) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_inline_stringops) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_ira_algorithm) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_ira_region) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_live_patching) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_reorder_blocks_algorithm) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_simd_cost_model) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_stack_reuse) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_auto_var_init) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_vect_cost_model) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_optimize) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_optimize_size) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_optimize_debug) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_optimize_fast) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_warn_inline) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_aggressive_loop_optimizations) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_align_functions) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_align_jumps) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_align_labels) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_align_loops) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_allocation_dce) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_store_data_races) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_associative_math) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_asynchronous_unwind_tables) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_auto_inc_dec) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_bit_tests) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_branch_on_count_reg) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_branch_probabilities) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_caller_saves) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_code_hoisting) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_combine_stack_adjustments) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_compare_elim_after_reload) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_conserve_stack) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_cprop_registers) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_crossjumping) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_cse_follow_jumps) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_cx_fortran_rules) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_cx_limited_range) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_dce) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_defer_pop) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_delayed_branch) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_delete_dead_exceptions) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_delete_null_pointer_checks) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_devirtualize) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_devirtualize_speculatively) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_dse) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_early_inlining) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_exceptions) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_expensive_optimizations) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_ext_dce) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_finite_loops) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_finite_math_only) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_float_store) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_fold_mem_offsets) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_fold_simple_inlines) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_forward_propagate) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_fp_int_builtin_inexact) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_no_function_cse) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_gcse) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_gcse_after_reload) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_gcse_las) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_gcse_lm) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_gcse_sm) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[4] = mask;
  mask = 0;
  if (opts_set->x_flag_graphite) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_graphite_identity) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_guess_branch_prob) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_exceptions) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_returning_calls) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_harden_control_flow_redundancy_skip_leaf) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_harden_compares) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_harden_conditional_branches) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_harden_control_flow_redundancy) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_hoist_adjacent_loads) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_if_conversion) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_if_conversion2) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_indirect_inlining) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_no_inline) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_inline_atomics) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_inline_functions) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_inline_functions_called_once) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_inline_small_functions) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_ipa_bit_cp) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_ipa_cp) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_ipa_cp_clone) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_ipa_icf) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_ipa_icf_functions) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_ipa_icf_variables) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_ipa_modref) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_ipa_profile) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_ipa_pta) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_ipa_pure_const) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_ipa_ra) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_ipa_reference) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_ipa_reference_addressable) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_ipa_sra) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_ipa_stack_alignment) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_ipa_strict_aliasing) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_ipa_vrp) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_ira_hoist_pressure) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_ira_loop_pressure) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_ira_share_save_slots) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_ira_share_spill_slots) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_isolate_erroneous_paths_attribute) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_isolate_erroneous_paths_dereference) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_ivopts) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_jump_tables) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_keep_gc_roots_live) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_late_combine_instructions) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_lifetime_dse) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_limit_function_alignment) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_live_range_shrinkage) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_loop_interchange) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_loop_nest_optimize) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_loop_parallelize_all) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_unroll_jam) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_lra_remat) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_errno_math) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_modulo_sched) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_modulo_sched_allow_regmoves) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_move_loop_invariants) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_move_loop_stores) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_non_call_exceptions) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_nothrow_opt) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_omit_frame_pointer) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_opt_info) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_optimize_sibling_calls) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_optimize_strlen) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[5] = mask;
  mask = 0;
  if (opts_set->x_flag_pack_struct) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_partial_inlining) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_pcc_struct_return) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_peel_loops) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_no_peephole) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_peephole2) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_plt) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_predictive_commoning) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_prefetch_loop_arrays) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_printf_return_value) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_profile_partial_training) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_profile_reorder_functions) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_reciprocal_math) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_ree) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_rename_registers) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_reorder_blocks) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_reorder_blocks_and_partition) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_reorder_functions) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_rerun_cse_after_loop) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_resched_modulo_sched) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_rounding_math) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_rtti) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_save_optimization_record) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_sched_critical_path_heuristic) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_sched_dep_count_heuristic) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_sched_group_heuristic) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_schedule_interblock) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_sched_last_insn_heuristic) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_sched_pressure) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_sched_rank_heuristic) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_schedule_speculative) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_sched_spec_insn_heuristic) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_schedule_speculative_load) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_schedule_speculative_load_dangerous) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_sched2_use_superblocks) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_schedule_fusion) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_schedule_insns) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_schedule_insns_after_reload) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_section_anchors) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_sel_sched_pipelining) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_sel_sched_pipelining_outer_loops) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_sel_sched_reschedule_pipelined) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_selective_scheduling) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_selective_scheduling2) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_semantic_interposition) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_setstackexecutable) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_short_enums) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_short_wchar) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_shrink_wrap) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_shrink_wrap_separate) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_signaling_nans) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_signed_zeros) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_single_precision_constant) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_split_ivs_in_unroller) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_split_loops) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_split_paths) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_split_wide_types) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_split_wide_types_early) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_ssa_backprop) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_ssa_phiopt) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_stack_clash_protection) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_stack_protect) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_stdarg_opt) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_store_merging) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[6] = mask;
  mask = 0;
  if (opts_set->x_flag_strict_aliasing) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_strict_enums) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_strict_volatile_bitfields) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_thread_jumps) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_threadsafe_statics) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_toplevel_reorder) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_tracer) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_trapping_math) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_trapv) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_tree_bit_ccp) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_tree_builtin_call_dce) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_tree_ccp) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_tree_ch) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_tree_coalesce_vars) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_tree_copy_prop) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_tree_cselim) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_tree_dce) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_tree_dom) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_tree_dse) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_tree_forwprop) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_tree_fre) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_tree_loop_distribute_patterns) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_tree_loop_distribution) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_tree_loop_if_convert) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_tree_loop_im) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_tree_loop_ivcanon) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_tree_loop_optimize) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_tree_loop_vectorize) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_tree_live_range_split) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_tree_partial_pre) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_tree_phiprop) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_tree_pre) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_tree_pta) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_tree_reassoc) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_tree_scev_cprop) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_tree_sink) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_tree_slp_vectorize) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_tree_slsr) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_tree_sra) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_tree_switch_conversion) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_tree_tail_merge) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_tree_ter) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_tree_vectorize) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_tree_vrp) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_unconstrained_commons) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_unreachable_traps) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_unroll_all_loops) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_cunroll_grow_size) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_unroll_loops) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_unsafe_math_optimizations) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_unswitch_loops) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_unwind_tables) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_var_tracking) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_var_tracking_assignments) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_var_tracking_assignments_toggle) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_var_tracking_uninit) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_variable_expansion_in_unroller) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_version_loops_for_strides) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_value_profile_transformations) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_web) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_wrapv) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_wrapv_pointer) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_debug_nonbind_markers_p) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_ix86_unroll_only_small_loops) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[7] = mask;
  mask = 0;
  if (opts_set->x_str_align_functions) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_str_align_jumps) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_str_align_labels) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_str_align_loops) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_patchable_function_entry) mask |= HOST_WIDE_INT_1U << 4;
  ptr->explicit_mask[8] = mask;
}
			 ...
			 struct cl_optimization *ptr)
{
  ...
  opts->x_param_vrp_block_limit = ptr->x_param_vrp_block_limit;
  ...
  opts->x_flag_ext_dce = ptr->x_flag_ext_dce;
  ...
  opts->x_flag_late_combine_instructions = ptr->x_flag_late_combine_instructions;
  ...
  mask >>= 1;
  opts_set->x_param_vrp_block_limit = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_ext_dce = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_late_combine_instructions = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_setstackexecutable = (mask & 1) != 0;
  mask >>= 1;
                       ...
                       struct cl_optimization *ptr)
{
  ...
  if (ptr->x_param_vrp_block_limit)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_vrp_block_limit",
             ptr->x_param_vrp_block_limit);
  ...
  if (ptr->x_flag_late_combine_instructions)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_late_combine_instructions",
             ptr->x_flag_late_combine_instructions);
                            ...
                            struct cl_optimization *ptr2)
{
  ...
  if (ptr1->x_param_vrp_block_limit != ptr2->x_param_vrp_block_limit)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_vrp_block_limit",
             ptr1->x_param_vrp_block_limit,
             ptr2->x_param_vrp_block_limit);
  ...
  if (ptr1->x_flag_ext_dce != ptr2->x_flag_ext_dce)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_ext_dce",
             ptr1->x_flag_ext_dce,
  ...
  if (ptr1->x_flag_late_combine_instructions != ptr2->x_flag_late_combine_instructions)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_late_combine_instructions",
             ptr1->x_flag_late_combine_instructions,
             ptr2->x_flag_late_combine_instructions);
  ...
  if (ptr1->x_flag_setstackexecutable != ptr2->x_flag_setstackexecutable)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_setstackexecutable",
             ptr1->x_flag_setstackexecutable,
             ptr2->x_flag_setstackexecutable);
...
cl_optimization_hash (struct cl_optimization const *ptr ATTRIBUTE_UNUSED)
{
  ...
  hstate.add_hwi (ptr->x_param_vrp_block_limit);
  ...
  hstate.add_hwi (ptr->x_flag_ext_dce);
  ...
  hstate.add_hwi (ptr->x_flag_late_combine_instructions);
  ...
  hstate.add_hwi (ptr->x_flag_setstackexecutable);
                            ...
                            struct cl_optimization *ptr)
{
  ...
  if (150000 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vrp_block_limit ^ 150000);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vrp_block_limit);
  if (3000 > (int ) 10)
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_ext_dce);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_late_combine_instructions);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_setstackexecutable);
                           ...
                           struct cl_optimization *ptr ATTRIBUTE_UNUSED)
{
  ...
  ptr->x_param_vrp_block_limit = (int ) bp_unpack_var_len_int (bp);
  if (150000 > (int ) 10)
    ptr->x_param_vrp_block_limit ^= 150000;
  ...
  ptr->x_flag_ext_dce = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_late_combine_instructions = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_setstackexecutable = (signed char ) bp_unpack_var_len_int (bp);
...
#error accel compiler cannot define Optimization attribute for target-specific option x_ix86_unroll_only_small_loops
#else
  ptr->x_ix86_unroll_only_small_loops = (signed char ) bp_unpack_var_len_int (bp);
#endif
  for (size_t i = 0; i < ARRAY_SIZE (ptr->explicit_mask); i++)
    ptr->explicit_mask[i] = bp_unpack_value (bp, 64);
}
...
cl_optimization_compare (gcc_options *ptr1, gcc_options *ptr2)
{
  ...
  if (ptr1->x_warn_analyzer_too_complex != ptr2->x_warn_analyzer_too_complex)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_analyzer_undefined_behavior_ptrdiff != ptr2->x_warn_analyzer_undefined_behavior_ptrdiff)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_c11_c23_compat != ptr2->x_warn_c11_c23_compat)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_c23_c2y_compat != ptr2->x_warn_c23_c2y_compat)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_pedantic != ptr2->x_pedantic)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_pedantic_ms_format != ptr2->x_warn_pedantic_ms_format)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_tautological_compare != ptr2->x_warn_tautological_compare)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_template_body != ptr2->x_warn_template_body)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_warn_unsuffixed_float_constants != ptr2->x_warn_unsuffixed_float_constants)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_warn_unterminated_string_initialization != ptr2->x_warn_unterminated_string_initialization)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_diagnostics_show_cwe != ptr2->x_flag_diagnostics_show_cwe)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_event_links != ptr2->x_flag_diagnostics_show_event_links)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_highlight_colors != ptr2->x_flag_diagnostics_show_highlight_colors)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_wrapv_pointer != ptr2->x_flag_wrapv_pointer)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_writable_rel_rdata != ptr2->x_flag_writable_rel_rdata)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_debug_internal_reset_location_views != ptr2->x_debug_internal_reset_location_views)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_debug_prune_btf != ptr2->x_debug_prune_btf)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_ix86_tune_no_default != ptr2->x_ix86_tune_no_default)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_NOP_FUN_DLLIMPORT != ptr2->x_TARGET_NOP_FUN_DLLIMPORT)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_ix86_partial_vec_fp_math != ptr2->x_ix86_partial_vec_fp_math)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_use_pe_aligned_common != ptr2->x_use_pe_aligned_common)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_prefer_vector_width_type != ptr2->x_prefer_vector_width_type)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_ix86_preferred_stack_boundary_arg != ptr2->x_ix86_preferred_stack_boundary_arg)
